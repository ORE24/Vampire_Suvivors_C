...
void UiDrawTitle(void)
{
    ...
    /* VAMPIRE SURVIVORS: 22sp + 50chars + 23sp = 95 visual */
    printf("║                      V  A  M  P  I  R  E      S  U  R  V  I  V  O  R  S                       ║\n");

    /* 빈 줄 */
    printf("║                                                                                               ║\n");

    /* TERMINAL EDITION: 29sp + 37chars + 29sp = 95 visual */
    ...
    /* 내부 박스 상단 (2+23+2+42+2+24 = 95 visual, 한글 없음) */
    printf("║  ┌─────────────────────┐  ┌────────────────────────────────────────┐  ┌──────────────────────┐║\n");

    /* 빈 행 */
    printf("║  │                     │  │                                        │  │                      │║\n");

    /* 헤더 행 (한글 6글자: 이동게임기타 → 내부 visual은 95 유지) */
    printf("║  │    [ 이  동 ]       │  │           [ 게   임 ]                  │  │     [ 기  타 ]       │║\n");

    /* 빈 행 */
    printf("║  │                     │  │                                        │  │                      │║\n");

    /* WASD/게임목표/기타R 행 (한글 22글자 → 공백 22개 줄여 보정됨) */
    ...
    /* 시작 버튼: 35sp + 25visual(한글4) + 35sp = 95 visual */
    printf("║                                   ▶   S  시  작  하  기   ◀                                   ║\n");

    /* 밑줄: 35sp + 25chars + 35sp = 95 visual */
    printf("║                                   ─────────────────────────                                   ║\n");
