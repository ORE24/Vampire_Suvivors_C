...
| 전투 | 마법탄, 신성 오라, 관통창, 별탄막 4종 자동 공격 구현 |
| 적 | HP 1, HP 3, HP 40 적 3종과 속도, 피해, 보상 차별화 구현 |
...
| P0 | `TAE` | 완료 | `Easy`, `Hard` 난이도 선택과 밸런스 적용 | 시작 전 난이도 선택 가능, 스폰 간격/강한 적 등장 시점/플레이어 체력 중 2개 이상 차등 적용 |
| P0 | `JONG` | 완료 | 무기 4종 MVP 확장 | 기존 2종 포함 총 4종 자동 공격이 동작하고 레벨업 강화에 연결됨 |
| P1 | `TAE` | 완료 | 적 3종 행동 차별화 | HP 차이 외에 속도, 데미지, 이동 쿨다운, 점수 중 2개 이상이 적마다 다름 |
