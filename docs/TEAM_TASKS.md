...
| 결과 | HP 0 게임오버, 5분 생존 `GAME CLEAR`, 랭킹 저장 구현 |
...
| P1 | `JAE` | 예정 | 통합 테스트와 발표 안정성 점검 | Windows Terminal 또는 PowerShell에서 5분 클리어까지 플레이하고 실행 결과 문서화 |
...
| 담당 | 책임 영역 | 주로 볼 파일 |
| --- | --- | --- |
| `JAE` | 구조 최적화, 통합 관리, Windows 실행 안정성, PR 검증, 테스트 관리 | `src/main.c`, `src/game.c`, `src/game.h`, `src/ranking.c`, `src/platform.c`, 문서 전체 |
...
- WinMM wav 사운드 밸런스와 Windows 실기기 재생 확인
